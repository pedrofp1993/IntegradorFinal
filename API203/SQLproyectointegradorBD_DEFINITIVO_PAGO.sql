...
IF OBJECT_ID('TB_TIPO_PAGO')IS NOT NULL
	DROP TABLE TB_TIPO_PAGO
GO
...
CREATE PROCEDURE USP_REGISTRO_PAGO
	...
	@LUGAR	 VARCHAR(30)  
AS 
 INSERT INTO TB_PAGO VALUES (@COD_TIPO_PAGO,@TARJETA,@NOMBRE_EVENTO,@FECHA_EVENTO,@LUGAR)
 GO 
...
INSERT INTO TB_TIPO_PAGO VALUES('PAGAR CON TARJETA')
INSERT INTO TB_TIPO_PAGO VALUES('PAGAR BANCO EN LINEA')
INSERT INTO TB_TIPO_PAGO VALUES('PAGO EFECTIVO')

INSERT INTO TB_PAGO VALUES(1,'25312635612','YUGIMOTO','10/12/2018','MIRAFLORES')
...
INSERT INTO TB_USUARIO_REGULADOR VALUES('OSCAR','CARRION','ozuma@hotmail.com',2,4,'UR_001','usser1','633434')
INSERT INTO TB_USUARIO_REGULADOR VALUES('LUIS','GANDIA','chicharito@hotmail.com',1,1,'UR_003','user2','3434')
INSERT INTO TB_USUARIO_REGULADOR VALUES('JOSE','BARRENZUELA','mya_34@hotmail.com',2,2,'UR_002','user3','12346')
INSERT INTO TB_USUARIO_REGULADOR VALUES('LESLY','AGUILAR','makoto_45@hotmail.com',1,3,'UR_004','user4','1243')
...
INSERT INTO TB_USUARIO_JUGADOR VALUES('PEDRO','CRISTOBAL','ped_cris_21@hotmail.com','MASTERPOKEMON','masterpokemon','AV. Panama 32',1,'76893456','1994/8/21')
INSERT INTO TB_USUARIO_JUGADOR VALUES('AUSTIN','FUJIKI','aus_213@hotmail.com','MASTERFIFA','masterfifa','av fontana 21',3,'79468234','1997/5/13')
INSERT INTO TB_USUARIO_JUGADOR VALUES('SERENA','KETCHUM','amor_ash_19@hotmail.com','OCTAVAGENERACION','octavageneracion','AV. Andromeda',4,'77892094','1999/1/5')
INSERT INTO TB_USUARIO_JUGADOR VALUES('AKIZA','FUDO','ak_fu_18@hotmail.com','5ds','5ds','AV. tiahuanaco',5,'73298439','2000/3/31')

INSERT INTO TB_EVENTO (NOMBRE_EVEN, DESC_EVEN, INFO,FECH_INC_EVEN,FECH_FIN_EVEN,CIUDAD_EVEN,
DIRECCION,REFERENCIA, CANT_ENTRADA, PRECIO,COD_USU_TIENDA) values ('Pokemon','eventos realizados para los entreanadores pokemon',
'entrenadores expertos','12/2/2016','16/5/2018','Lima','Av andormeda 232','Buena',20,
14,1)
go
...
AS
select ID_USUARIO_JUG, CONTRASEÑA
...
@COD_ID_REG,@ID_USU_REGUL,@CONTRA_USU_REGUL)
go
...
AS
INSERT INTO TB_USUARIO_JUGADOR VALUES(@NOMBRE_USU_JUGADOR,@APELLIDO_USU_JUGADOR,@CORREO_USU_JUGADOR,@ID_USUARIO_JUGADOR,@CONTRASEÑA_USU_JUGADOR,@DIRECCION,@CIUDAD,@DNI,@FECHA_NACI_USU_JUGADOR)
go
...
AS
INSERT INTO TB_USUARIO_TIENDA VALUES(@RAZON_SOCIAL,@REPRESENTANTE,@CORREO_ELECTRONICO,@DIRECCION,@TELEFONO,@FECHA_CONSTI,@RUC,@ID_USU_TIENDA,@CONTRASEÑA_TIENDA)
go
...
@DIRECCION,@REFRENCIA,@CANTIDAD,@PRECIO,@COD_USU_TIENDA	)
GO

EXEC  USP_REGISTRAR_EVENTO 'PIKACHU BATTLE','GUERRA DE CARTAS','BATALLA A MUERTE CON TARJETAS','12/12/2018','30/12/2018','LIMA ','AV.ARENALES','CRUCE AV.AREQUIPA',20,10.5,2
GO
