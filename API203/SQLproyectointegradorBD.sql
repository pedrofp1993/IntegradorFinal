...
DIRECCION,REFERENCIA,NOMBRE_PROMOTOR, CANT_ENTRADA, PRECIO, MIN_CANT_ORD, CANT_DISP, MAX_CANT_USU,
DESC_ENTRADA, NOMBRE_EMPRESA, RUC_EMPRESA, NUMB_CUENTA, BANCO, TIPO_MONEDA,NOMBRE_CONTACTO,
TELF_CONTACTO,EMAIL_CONTACTO) values ('Pokemon','eventos realizados para los entreanadores pokemon',
'entrenadores expertos','12/2/2016','16/5/2018','Lima','Av andormeda 232','Buena','Jesus Benavides',20,
14,12,8,12,'Miren el mejor evento','WebGamers','4234234','5435345','BCP','$','Humberto Grieve','54345',
'dsfhi@hotmail.com')
...
/*EVENTOS*/
IF OBJECT_ID('USP_REGISTRO_EVENTO')IS NOT NULL
	DROP PROCEDURE USP_REGISTRO_EVENTO
GO

CREATE PROCEDURE USP_REGISTRO_EVENTO
@NOMBRE_EVEN VARCHAR(100),
@DESC_EVEN VARCHAR(100),
@INFO VARCHAR(100),
@DIRECCION VARCHAR(50),
@TELEFONO CHAR(10),
@FECHA_CONSTI DATE,
...
@CONTRASEÑA_TIENDA VARCHAR(30)
AS
INSERT INTO TB_EVENTO VALUES(@RAZON_SOCIAL,@REPRESENTANTE,@CORREO_ELECTRONICO,@DIRECCION,@TELEFONO,@FECHA_CONSTI,@RUC,@ID_USU_TIENDA,@CONTRASEÑA_TIENDA)
go

execute USP_REGISTRO_EVENTO 'Megaman', 'Gustavo Rodriguez', 'larry_papi@hotmail.com','Av yusaku','994375932', '2017/11/24','54353534', 'ASTRO','astro'
GO
...
AS
SELECT DESC_EVEN, FECH_INC_EVEN FROM TB_EVENTO
GO
...
IF OBJECT_ID('USP_ELIMINAR_EVENTO')IS NOT NULL
	DROP PROCEDURE USP_ELIMINAR_EVENTO
GO
