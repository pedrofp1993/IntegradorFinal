...
CREATE TABLE TB_PAGO (
	...
	COD_TIPO_PAGO INT NOT NULL REFERENCES TB_TIPO_PAGO,
	COD_TARJETA INT NOT NULL REFERENCES TB_TARJETA
)
GO 
...
IF OBJECT_ID('USP_LISTAR_EVENTO_2')IS NOT NULL
	DROP PROCEDURE USP_LISTAR_EVENTO_2
GO

CREATE PROCEDURE USP_LISTAR_EVENTO_2
AS
SELECT NOMBRE_EVEN, INFO  FROM TB_EVENTO
GO

EXECUTE USP_LISTAR_EVENTO_2
GO
...
FECH_FIN_EVEN, UT.COD_USU_TIENDA,UT.RAZON_SOCIAL, DESC_EVEN FROM TB_EVENTO E
...
AS  
SELECT NOMBRE_EVEN, DIRECCION, FECH_INC_EVEN,
...
@FECH_INI VARCHAR(100),
@FECG_FIN VARCHAR(100),
@DESC_EVENT VARCHAR(100)
AS  
UPDATE TB_EVENTO
SET NOMBRE_EVEN = @NOM_EVEN,
DIRECCION = @DIRECCION,
FECH_INC_EVEN = @FECH_INI,
FECH_FIN_EVEN = @FECG_FIN,
DESC_EVEN = @DESC_EVENT
WHERE
COD_EVEN = @COD_EVEN
GO

EXECUTE USP_APROBAR_EVENTOSE 1, 'KOek','AV EL NEGRO', '11/12/2011','15/3/2012','evento de los simsopmn'
go
